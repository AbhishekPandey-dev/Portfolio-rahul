...
export const Footer = () => {
  return (
    <footer className="w-full flex flex-col md:flex-row justify-between items-center px-12 py-16 gap-8 bg-neutral-950 border-t border-white/10 font-headline font-medium">
      <div className="text-2xl font-black text-white uppercase">Rahul Sharma</div>
